  ...
  return (
    ...
    >
      <div>
        ...
        <p className="mt-1.5 text-sm text-gray-500 dark:text-gray-400">Start your AI-powered career journey</p>
      </div>
      ...
      <p className="text-center text-sm text-gray-500 dark:text-gray-400">
        ...
        <Link to="/login" className="font-medium text-brand-600 hover:text-brand-700 dark:text-brand-400 dark:hover:text-brand-300 transition-colors">Sign in</Link>
      </p>
    </motion.form>
  )
}
