...
export default function InterestSelector({ interests, onToggle, error }: InterestSelectorProps) {
  return (
          ...
          return (
            <motion.button
              ...
              className={`flex items-center gap-3 rounded-xl border px-4 py-3.5 text-sm font-medium transition-all ${
                selected
                  ? "border-brand-200 bg-brand-50 text-brand-700 shadow-sm dark:border-brand-700 dark:bg-brand-950/40 dark:text-brand-300"
            ...
            >
              ...
              {selected && (
                <svg
                  className="ml-auto h-4 w-4 text-brand-600 dark:text-brand-400"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth={2.5}
