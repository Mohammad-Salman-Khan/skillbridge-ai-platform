...
export default function DashboardLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 dark:bg-gray-950 transition-colors duration-200">
      <aside className="flex w-64 flex-col border-r bg-white dark:border-gray-800 dark:bg-gray-900 transition-colors duration-200">
        <div className="flex items-center gap-2.5 border-b border-gray-100 px-6 py-5 dark:border-gray-800">
          ...
          <span className="text-lg font-bold tracking-tight text-gray-900 dark:text-white">SkillBridge</span>
        </div>
        ...
        <div className="border-t border-gray-100 p-3 dark:border-gray-800">
          <button
            ...
            className="flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 transition-all"
